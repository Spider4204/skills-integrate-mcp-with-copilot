document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivities(activities) {
    ...
    filtered.sort((a, b) => {
      ...
      if (sort === "za") return b[0].localeCompare(a[0]);
      return 0;
    });
  ...
  // Initialize app
  fetchActivities();
  if (searchInput) searchInput.addEventListener("input", () => renderActivities(allActivities));
  if (sortSelect) sortSelect.addEventListener("change", () => renderActivities(allActivities));
});
